    ...
    <div className="bg-dry py-4 border-t-2 border-black">
      <div className="container mx-auto px-2">
        <div className="grid grid-cols-2 md:grid-cols-7 
             xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 justify-between">
          {
          ...
          <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
            ...
            <p className="leading-7 text-sm text-border mt-3">
              <span>
                Hoang Hoa Tham, Distric Binh Thanh, <br /> Ho Chi Minh City, HCM 70000
              </span>
              <br />
              <span>Tell: +84 798 990 797</span>
              <br />
              <span>Email: minhthu3012000@gmail.com</span>
            </p>
          </div>
        </div>
      </div>
